...
- **Windows ZIP**：[EasyLearningCS-win-v2.0.zip](https://github.com/rabbitalex/EasyLearningCS/releases/download/latest-dist/EasyLearningCS-win-v2.0.zip)
- **macOS ZIP**：[EasyLearningCS-mac-v2.0.zip](https://github.com/rabbitalex/EasyLearningCS/releases/download/latest-dist/EasyLearningCS-mac-v2.0.zip)
