...
- **Windows ZIP**：[EasyLearningCS-win-v2.0.1.zip](https://github.com/rabbitalex/EasyLearningCS/releases/download/latest-dist/EasyLearningCS-win-v2.0.1.zip)
- **macOS ZIP**：[EasyLearningCS-mac-v2.0.1.zip](https://github.com/rabbitalex/EasyLearningCS/releases/download/latest-dist/EasyLearningCS-mac-v2.0.1.zip)
...
请不要直接双击 `开始学习.html` 或 `V2.0/index.html`，否则只会打开静态页面，**不会写入 `user-data.json`**。
...
- `dist/EasyLearningCS-win-v2.0.1.zip`
- `dist/EasyLearningCS-mac-v2.0.1.zip`
...
- `开始学习.html`：启动提示页，提醒用户不要直接用静态 HTML 保存进度
