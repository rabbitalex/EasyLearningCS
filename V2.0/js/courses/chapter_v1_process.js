  ...
  <div id="processStateDemo" style="position:relative;padding:1rem;min-height:180px">
    <div style="display:flex;justify-content:center;flex-wrap:wrap;gap:1.5rem;margin:1rem 0">
      <div id="pState_new" class="t0-fadein" style="animation-delay:0.2s;text-align:center">
        <div style="width:70px;height:70px;border-radius:50%;border:3px solid rgba(108,92,231,0.4);background:rgba(108,92,231,0.15);display:flex;align-items:center;justify-content:center;font-size:1.5rem;margin:0 auto 0.3rem;transition:all 0.5s" id="psBubbleNew">📝</div>
        <div style="font-size:0.7rem;font-weight:700;color:#6c5ce7">新建</div>
      </div>
