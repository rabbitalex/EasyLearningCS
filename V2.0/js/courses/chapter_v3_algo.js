...
<div class="theory-anim-box">
  ...
  <div style="padding:1rem">
    <div style="display:flex;gap:0.5rem;margin-bottom:1rem;flex-wrap:wrap;justify-content:center">
      <button onclick="startSortAnim('bubble')" style="padding:0.4rem 0.8rem;border-radius:6px;border:none;background:#6c5ce7;color:white;font-size:0.7rem;font-weight:700;cursor:pointer">冒泡排序</button>
...
function renderSortBars(hi1,hi2){var el=document.getElementById('sortBars');if(!el)return;el.innerHTML='';sortArr.forEach(function(v,i){var color='rgba(108,92,231,0.6)';if(i===hi1)color='#FF9800';if(i===hi2)color='#fd79a8';el.innerHTML+='<div style="width:12px;height:'+v+'px;background:'+color+';border-radius:3px 3px 0 0;transition:height 0.15s"></div>';});}
...
<div class="theory-anim-box">
  ...
  <div style="padding:1rem">
    <div style="text-align:center;margin-bottom:0.5rem">
      ...
      <input type="number" id="bsTarget" value="23" min="1" max="50" style="width:50px;padding:0.3rem;border-radius:6px;border:1px solid rgba(108,92,231,0.4);background:rgba(108,92,231,0.15);color:white;font-weight:700;text-align:center;font-size:0.8rem">
      <button onclick="runBinarySearch()" style="padding:0.3rem 0.8rem;border-radius:6px;border:none;background:#6c5ce7;color:white;font-size:0.7rem;font-weight:700;cursor:pointer;margin-left:0.3rem">查找</button>
    </div>
...
function renderBsArray(lo,hi,mid,found){var el=document.getElementById('bsArray');el.innerHTML='';bsData.forEach(function(v,i){var bg='rgba(255,255,255,0.06)',bor='rgba(255,255,255,0.15)',col='rgba(255,255,255,0.5)';if(i>=lo&&i<=hi){bg='rgba(108,92,231,0.15)';bor='rgba(108,92,231,0.3)';col='#a29bfe';}if(i===mid){bg='rgba(255,152,0,0.3)';bor='#FF9800';col='#FF9800';}if(found===i){bg='rgba(105,240,174,0.3)';bor='#69F0AE';col='#69F0AE';}el.innerHTML+='<div style="min-width:28px;height:28px;display:flex;align-items:center;justify-content:center;border:1px solid '+bor+';background:'+bg+';border-radius:5px;font-size:0.65rem;font-weight:700;color:'+col+';font-family:monospace">'+v+'</div>';});}
